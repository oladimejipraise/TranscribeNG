    ...
    <div className="min-h-screen bg-dark flex items-center justify-center px-4">
      <div className="w-full max-w-sm">
        ...
        <div className="bg-surface border border-subtle rounded-2xl px-8 py-10">
          ...
          <p className="text-sm text-cream/40 mb-8">Log in to your account to continue</p>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            ...
            <div className="relative">
              ...
              <div className="flex justify-end mt-1">
                <Link to="/forgot-password" className="text-2xs text-accent hover:text-accent/80 transition-colors">
                  Forgot password?
                </Link>
              </div>
            </div>
            ...
            <div className="flex items-center gap-2">
              <input type="checkbox" id="remember" className="accent-forest w-3.5 h-3.5" />
              <label htmlFor="remember" className="text-xs text-cream/40 cursor-pointer">Remember me</label>
            </div>
