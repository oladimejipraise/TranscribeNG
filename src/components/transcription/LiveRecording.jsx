      ...
      <main className="flex-1 overflow-y-auto">
        <div className="px-8 py-8 max-w-4xl mx-auto">
          ...
          <div className="flex items-center justify-between mb-6">
            <div>
              <h1 className="font-syne font-bold text-2xl text-cream">Live Recording</h1>
              <p className="text-sm text-cream/40 mt-0.5">Transcribe in real time</p>
            </div>
            <div className="flex items-center gap-3">
              <select className="bg-white/5 border border-subtle text-cream/70 text-xs rounded-lg px-3 py-2 outline-none focus:border-forest transition-colors cursor-pointer">
                {LANGUAGES.map((l) => (
              ...
              <button
                onClick={reset}
                className="text-xs text-cream/40 hover:text-cream border border-subtle hover:border-white/20 px-3 py-2 rounded-lg transition-all cursor-pointer"
              >
                Reset
              </button>
            </div>
            ...
            <div className="flex items-center justify-between mt-5">
              ...
              <div className="flex items-center gap-3">
                ...
                <button
                  ...
                  className={`w-14 h-14 rounded-full flex items-center justify-center text-xl transition-all duration-200 cursor-pointer shadow-lg ${
                    recording
