const LANGUAGES = [
  {
    ...
    translation: "Good morning sir, thank you for coming to speak with me today.",
        ...
        {LANGUAGES.map((lang) => (
          ...
          >
            ...
            <div className="flex items-center gap-3 mb-5">
              ...
              <div>
                <h3 className="font-syne font-bold text-lg text-cream">{lang.name}</h3>
                <span className={`text-2xs px-2 py-0.5 rounded-full border font-medium ${lang.badge}`}>
                  Fully supported
                </span>
              </div>
            </div>
